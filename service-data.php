...
if (isset($_POST['sendrequest']) && !empty($_POST['sendrequest'])) {
	...
	if(!isset($_SESSION["user_id"]) && empty($_SESSION["user_id"]))
	{
		...
		$query="INSERT INTO `tbl_Service_response`(`Service_provider_ID`, `User_ID`, `Service_User_Response`) VALUES ('".$_POST['Service_provider_ID']."','".$_SESSION['user_id']."','Request')";
					...
					<div class="row">
						<div class="col-md-12 ftco-animate">
							<div class="single-slider owl-carousel">
								<div class="item">
									<div class="properties-img" style="background-image: url(images/service_image/<?php echo !empty($fh_user['Service_img'])?$fh_user['Service_img']:'images.jpg'; ?>);"></div>
								</div>
									 <!--<div class="item">
										<div class="properties-img" style="background-image: url(images/service_image/<?php echo !empty($fh_user['Service_img'])?$fh_user['Service_img']:'images.jpg'; ?>);"></div>
									</div>
							...
							<div class="col-md-12 Properties-single mt-4 mb-5 ftco-animate">
								...
								<div class="d-md-flex mt-5 mb-5">
									<ul>
										<!-- <li><span>Service Type : </span><?php echo $fh_user['Service_Type_Name']; ?></li>
										<li><span>Service Room: </span> <?php echo $fh_user['Service_Room_Name']; ?></li>
									-->
								</ul>
								<p>Time 10:00Am To 11:00PM
									<!-- <ul class="ml-md-5">
								...
								$fetch="select * FROM tbl_service_response where Service_provider_ID=".$_GET['p']." AND User_ID=".$_SESSION['user_id'];
								...
								if($c==0)
								{
									...
									?>
									<form action="service-data.php?p=<?php echo $_GET['p'];?>" class="bg-white p-5 contact-form" method="post">
										<input type="hidden" name="Service_provider_ID" value="<?php echo $_GET['p'];?>">
							...
							<div class="row">
								<div class="col-md-6 ftco-animate">
									<div class="properties">
										<a href="Service-single.html" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/properties-1.jpg);">
										...
										<div class="text p-3">
											...
											<div class="d-flex">
												<div class="one">
													<h3><a href="Service-single.html">North Parchmore Street</a></h3>
													<p>Apartment</p>
												</div>
												<div class="two">
								...
								<div class="col-md-6 ftco-animate">
									<div class="properties">
										<a href="Service-single.html" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/properties-2.jpg);">
											<div class="icon d-flex justify-content-center align-items-center">
												<span class="icon-search2"></span>
											</div>
										</a>
