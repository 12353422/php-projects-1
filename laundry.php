	...
	<div class="container">
		<div class="row no-gutters slider-text align-items-center justify-content-center">
			<div class="col-md-9 ftco-animate text-center">
				...
				<h1 class="mb-3 bread">Laundry Service</h1>
			</div>
		</div>
	</div>
</div>
			...
			{ 
				...
				<div class="col-md-4 ftco-animate">
					<div class="properties">
						<a href="service-data.php?p=<?php echo $fh_user['Service_provider_ID'];?>" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/service_image/<?php echo !empty($fh_user['download'])?$fh_user['Service_img']:'L2.jpg'; ?>);">
